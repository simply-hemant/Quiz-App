...
(4,'Which of the following is not a primitive data type in Java?', 'String', 'java'),
(5,'What is the size of an int in Java?', '4 bytes', 'java'),
(6,'Which operator is used to compare two values in Java?', '==', 'java'),
(7,'What is the superclass of all classes in Java?', 'Object', 'java'),
(8,'Which package is automatically imported in every Java program?', 'java.lang', 'java'),
(9,'What is the output of the expression 5 + 2 * 3 in Java?', '11', 'java'),
(10, 'Which of these access modifiers makes a variable accessible only within its own class?', 'private', 'java'),

(11, 'Who developed Python?', 'Guido van Rossum', 'python'),
(12, 'Which keyword is used to define a function in Python?', 'def', 'python'),
(13, 'What data type is the result of 3 / 2 in Python 3?', 'float', 'python'),
(14, 'Which of the following is a mutable data type?', 'list', 'python'),
(15, 'What is used to handle exceptions in Python?', 'try-except', 'python'),
(16, 'What symbol is used for comments in Python?', '#', 'python'),
...
(23, 'Which header is used for input/output in C++?', 'iostream', 'cpp'),
(24, 'Which keyword is used to define a constant in C++?', 'const', 'cpp'),
(25, 'Which operator is used to access members of a class via pointer?', '->', 'cpp'),
(26, 'What is the default access modifier in class?', 'private', 'cpp'),
(27, 'What is the use of "new" in C++?', 'Dynamic memory allocation', 'cpp'),
(28, 'Which loop ensures execution at least once?', 'do-while', 'cpp'),
(29, 'What is STL in C++?', 'Standard Template Library', 'cpp'),
(30, 'Which function is used to allocate memory in C++?', 'new', 'cpp'),

(31, 'Which keyword is used to declare variables in JavaScript?', 'let', 'js'),
(32, 'Which method is used to parse JSON?', 'JSON.parse()', 'js'),
(33, 'What does NaN stand for?', 'Not a Number', 'js'),
(34, 'Which company developed JavaScript?', 'Netscape', 'js'),
(35, 'Which symbol is used for comments in JavaScript?', '//', 'js'),
(36, 'What is the type of "null" in JavaScript?', 'object', 'js'),
(37, 'What is used to define asynchronous code?', 'async/await', 'js'),
(38, 'Which array method adds an element at the end?', 'push()', 'js'),
(39, 'Which operator is used to compare value and type?', '===', 'js'),
(40, 'How do you define a function in JavaScript?', 'function', 'js');
